		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="widget-body">
					...
					<form method="post" action="<?php echo U('User/addGroupHandle');?>" id="validation-form" class="form-horizontal" novalidate="novalidate">
						<div class="form-group">
							<label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">用户组名:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="name" name="title">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">权限(默认不填写):</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="rule" name="rule">
								</div>
							</div>
						</div>					
