		...
		<div class="row">
			<div class="col-xs-12">
				<div class="widget-header widget-header-blue widget-header-flat">
					<h4 class="lighter">修改用户</h4>
				</div>
				<div class="widget-body">
					<div class="widget-main">
					<form method="post" action="<?php echo U('User/updateUser');?>" id="validation-form" class="form-horizontal" novalidate="novalidate">
						<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" value="<?php echo ($v['id']); ?>" />
						<div class="form-group">
							<label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">用户名:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="name" name="username" value="<?php echo ($v['username']); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label for="password" class="control-label col-xs-12 col-sm-3 no-padding-right">密码:</label>
						...
						<div class="form-group">
							<label for="password2" class="control-label col-xs-12 col-sm-3 no-padding-right">确认密码:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="password" class="col-xs-12 col-sm-4" id="password2" name="repassword">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div>
									<label class="blue">
										<input type="radio" class="ace" value="1" name="lock" <?php if($v[lock] == 1): ?>checked='checked'<?php endif; ?>>
								...
								<div>
									<label class="blue">
										<input type="radio" class="ace" value="0" name="lock" <?php if($v[lock] == 0): ?>checked='checked'<?php endif; ?>>
						...
						<div class="form-group">
							<label for="platform" class="control-label col-xs-12 col-sm-3 no-padding-right">选择用户组:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<select name="role_id" id="platform" class="input-medium">
										<option value="">------------------</option>
										<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php if($vo["id"] == $group_id): ?>selected="selected"<?php endif; ?>><?php echo ($vo['title']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
