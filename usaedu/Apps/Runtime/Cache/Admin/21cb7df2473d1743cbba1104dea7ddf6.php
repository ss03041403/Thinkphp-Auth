					...
					<table class="table table-striped table-bordered table-hover" id="sample-table-1">
						...
						<tbody>
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
								...
								<td class="hidden-480"><?php echo ($v["term"]); ?></td>
								<td class="hidden-480"><?php echo ($v["moduleName"]); ?></td>
								<td>
									<?php if(!$v[status]): ?><button class="btn btn-minier btn-danger">关闭</button><?php else: ?><button class="btn btn-minier btn-success">开启</button><?php endif; ?>
								</td>
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
										
										<a class="green" href="<?php echo U('updateRule',array('id'=>$v['id']));?>">
											<i class="icon-pencil bigger-130"></i>
										</a>

										<a class="red" href="<?php echo U('deleteRule',array('id'=>$v['id']));?>" onclick='return del();'>
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo U('updateRule',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
												...
												<li>
													<a href="<?php echo U('deleteRule',array('id'=>$v['id']));?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick='return del();'>
														<span class="red">
