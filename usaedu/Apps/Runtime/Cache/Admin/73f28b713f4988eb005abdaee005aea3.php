							...
							<?php if(is_array($group)): $i = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
										<a class="blue" href="<?php echo U('groupAuth',array('id'=>$v[id],'name'=>$v[title]),'');?>">
											<i class="icon-cogs bigger-130"></i>
										</a>

										<a class="green" href="<?php echo U('updateGroup',array('id'=>$v[id]),'');?>">
											<i class="icon-pencil bigger-130"></i>
										</a>

										<a class="red" href="<?php echo U('delGroup',array('id'=>$v['id']));?>" onclick='return del();'>
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo U('groupAuth',array('id'=>$v[id],'name'=>$v[title]),'');?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="blue">
												...
												<li>
													<a href="<?php echo U('updateGroup',array('id'=>$v[id]));?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
												...
												<li>
													<a href="<?php echo U('delGroup',array('id'=>$v['id']));?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick='return del();'>
														<span class="red">
