...
<!-- page specific plugin scripts -->
	...
	<script src="/tk-xm/usaedu/Public/Statics/Admin/assets/js/jquery.dataTables.min.js"></script>
	<script src="/tk-xm/usaedu/Public/Statics/Admin/assets/js/jquery.dataTables.bootstrap.js"></script>
	<script type="text/javascript">
	function del()
	{
	    if(confirm("确定要删除吗？"))
