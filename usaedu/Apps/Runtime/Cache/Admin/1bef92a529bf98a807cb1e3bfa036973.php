		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="widget-body">
					...
					<form method="post" action="<?php echo U('updateRule');?>" id="validation-form" class="form-horizontal" novalidate="novalidate">
						<?php if(is_array($rule)): $i = 0; $__LIST__ = $rule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" value="<?php echo ($v['id']); ?>" />
						<div class="form-group">
							<label for="name" class="control-label col-xs-12 col-sm-3 no-padding-right">权限路径:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="name" name="name" value="<?php echo ($v["name"]); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="title" name="title" value="<?php echo ($v["title"]); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="condition" name="condition" value="<?php echo ($v["condition"]); ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<select name="mid" class="input-medium">
										<?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['id']); ?>" <?php if($vo["id"] == $v["mid"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo['moduleName']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
								</div>
							</div>
