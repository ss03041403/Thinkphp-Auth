			...
			<div class="col-xs-12">
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover" id="sample-table-1">
						...
						<tbody>
							<?php if(is_array($user)): $i = 0; $__LIST__ = $user;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if(!in_array($v[id],C('ADMINISTRATOR'))): ?><tr>
								<td class="center">
									<label>
										<input type="checkbox" class="ace" />
										<span class="lbl"></span>
								...
								<td class="hidden-480"><?php echo (date('Y-m-d H:i', $v["login_time"])); ?></td>
								<td class="hidden-480"><?php echo ($v["login_ip"]); ?></td>
								<td class="hidden-480"><?php echo (date('Y-m-d H:i', $v["rsgtime"])); ?></td>
								<td>
									<?php if($v[lock] == 1): ?><a href="<?php echo U('UserLock',array('id'=>$v[id],'lock'=>0),'');?>" class="btn btn-minier btn-success">启用中</a><?php else: ?><a href="<?php echo U('UserLock',array('id'=>$v[id],'lock'=>1),'');?>" class="btn btn-minier btn-danger">禁用</a><?php endif; ?>
								</td>
								<td class="hidden-480">
									<?php if(is_array($v["classify"])): $i = 0; $__LIST__ = $v["classify"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i; echo ($r["title"]); endforeach; endif; else: echo "" ;endif; ?>
								</td>
								<td>
									<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
										
										<a class="green" href="<?php echo U('updateUser',array('id'=>$v['id']));?>">
											<i class="icon-pencil bigger-130"></i>
										</a>

										<a class="red" href="<?php echo U('delUser',array('id'=>$v['id']));?>" onclick='return del();'>
									...
									<div class="visible-xs visible-sm hidden-md hidden-lg">
										<div class="inline position-relative">
											...
											<ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
												...
												<li>
													<a href="<?php echo U('updateUser',array('id'=>$v['id']));?>" class="tooltip-success" data-rel="tooltip" title="Edit">
														<span class="green">
												...
												<li>
													<a href="<?php echo U('delUser',array('id'=>$v['id']));?>" class="tooltip-error" data-rel="tooltip" title="Delete" onclick='return del();'>
														<span class="red">
...
<!-- page specific plugin scripts -->
	...
	<script src="/my/tk-xm/usaedu/Public/Statics/Admin/assets/js/jquery.dataTables.min.js"></script>
	<script src="/my/tk-xm/usaedu/Public/Statics/Admin/assets/js/jquery.dataTables.bootstrap.js"></script>
	<script type="text/javascript">
	function del()
	{
	    if(confirm("确定要删除吗？"))
