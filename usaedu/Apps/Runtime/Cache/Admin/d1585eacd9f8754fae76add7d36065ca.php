                ...
                <li class="active open">
                    ...
                    <ul class="submenu">
                        <li class="active">
                            ...
                            <ul class="submenu">
                                <li>
                                    <a href="<?php echo U('Auth/modList');?>">
                                        <i class="icon-eye-open"></i>
                                        查看模块
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo U('Auth/addMod');?>">
                                        <i class="icon-plus"></i>
                                        添加模块
                                    </a>
                                </li>
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="widget-header widget-header-blue widget-header-flat">
					<h4 class="lighter">添加模块</h4>
				</div>
				<div class="widget-body">
					<div class="widget-main">
					<form method="post" action="<?php echo U('Auth/addModHandle');?>" id="validation-form" class="form-horizontal" novalidate="novalidate">
						<div class="form-group">
							<label for="moduleName" class="control-label col-xs-12 col-sm-3 no-padding-right">模型名称:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="moduleName" name="moduleName">
								</div>
							</div>
						</div>
