		...
		<div class="row">
			<div class="col-xs-12">
				<div class="widget-header widget-header-blue widget-header-flat">
					<h4 class="lighter">修改权限分类</h4>
				</div>
				<div class="widget-body">
					<div class="widget-main">
					<form method="post" action="<?php echo U('updateCate');?>" id="validation-form" class="form-horizontal" novalidate="novalidate">
						<?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><div class="form-group">
							<label for="moduleName" class="control-label col-xs-12 col-sm-3 no-padding-right">权限分类名称:</label>

							<div class="col-xs-12 col-sm-9">
								<div class="clearfix">
									<input type="text" class="col-xs-12 col-sm-4" id="moduleName" name="moduleName" value="<?php echo ($v["moduleName"]); ?>">
								</div>
							</div>
